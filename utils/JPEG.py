...
class DiffJPEG(nn.Module):    
    def __init__(self, differentiable=True, height=512, width=512, quality=75,rounding=round_only_at_0):
        ...
        self.decompress = decompress_jpeg(height, width, rounding=rounding, factor=factor).cuda()
