...
def main(args):
    ...
    if setting['network_arch'] == 'UAMFDv2':
        from models.UAMFDv2_Net_f_test import UAMFD_Net
        ...
        if setting['val'] == 0:
            ...
            for i, items in enumerate(train_loader):
               ...
               (input_ids1, attention_mask1, token_type_ids1), (image1, labels1, sents1)
                    ...
                    # vgg_only_output,
                    mix_output, mm_only_output, image_only_output, text_only_output, aux_output, mi_loss = model(input_ids=input_ids,
