        ...
        with torch.no_grad():
            ...
            if setting['get_MLP_score']>0:
                ...
                if validate_acc > best_validate_acc:
                    ...
                    best_validate_dir = "{}/{}/test/{}_{}{}_{}.pkl".format(args.output_file,setting['train_dataname'],str(epoch + 1),str(datetime.datetime.now().month),str(datetime.datetime.now().day),
...
def evaluate(validate_loader, model, criterion, progbar=None, setting={}):
    ...
    root_path = '/home/yanwang_nuist/dev_workspace/prj_python/fnd-bootstrap/evaluate_txt_xlsx'
