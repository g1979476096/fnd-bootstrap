...
def main(args):
    ...
    if setting['network_arch'] == 'UAMFDv2':
        from models.UAMFDv2_Net_a_test import UAMFD_Net
        ...
        if setting['val'] == 0:
            ...
            for i, items in enumerate(train_loader):
               ...
               (input_ids1, attention_mask1, token_type_ids1), (image1, labels1, sents1)
                    ...
                    # 0416
                    # loss = loss_CE + 1.0*loss_single_modal
        ...
        with torch.no_grad():
            ...
            if setting['get_MLP_score']>0:
                ...
                if validate_acc > best_validate_acc:
                    ...
                    best_validate_dir = "{}/{}_dis/test/{}_{}{}_{}.pkl".format(args.output_file,setting['train_dataname'],str(epoch + 1),str(datetime.datetime.now().month),str(datetime.datetime.now().day),
